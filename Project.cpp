...
struct BookInfo {
   int Id , pageno , PbMonth , PbDay , PbYear ,CountOfReviews, CountOfTextReviews ;
...
class BookDataSet {
  ...
  int height(BookInfo *t)
   ...
   BookInfo *rr_rotat(BookInfo *parent)
  {
   BookInfo *t;
   t = parent->rightchild;
  ...
  BookInfo *ll_rotat(BookInfo *parent)
  {
   BookInfo *t;
   t = parent->leftchild;
 ...
 BookInfo *lr_rotat(BookInfo *parent)
  {
   BookInfo *t;
   t = parent->leftchild;
  ...
  BookInfo *rl_rotat(BookInfo *parent)
   {
   BookInfo *t;
   t = parent->rightchild;
...
int main()
{
	...
	cout<<endl<<endl<<"       Data is loaded Successfully!!!!!!!!"<<endl<<endl;
	while(1)
	{
	    MainMenu(Set,Inv);
	    system("cls");
...
void MainMenu(BookDataSet & V1 ,InvalidList &L1)
{
	...
	cout<<"  (1)       Have a look on Useful Data "<<endl;
	cout<<"  (2)       Invalid  Records "<<endl<<endl;
